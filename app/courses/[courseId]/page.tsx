      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            { id: 1, title: "What is JavaScript?", duration: "10 min", completed: true },
            { id: 2, title: "Variables and Data Types", duration: "15 min", completed: true },
            { id: 3, title: "Functions and Scope", duration: "20 min", completed: false },
          ]
        }
      ]
    }
